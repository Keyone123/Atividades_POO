...
public class TesteNormal {
    ...
    @Test
    public void testarCadastroProdutosInvalidos() throws ProdutoJaCadastrado, DadosInvalidos {
        Fornecedor f1 = new Fornecedor(1, "Forn1");
    ...
    @Test
    public void testarVendaInvalida()
            throws ProdutoJaCadastrado, DadosInvalidos, ProdutoNaoPerecivel, ProdutoInexistente, ProdutoVencido {
        Fornecedor f1 = new Fornecedor(1, "Forn1");
        Produto p1 = new Produto(1, "coca-cola", 5, 0.5, f1);
    ...
    public void testarVendaProdutosPereciveis()
            throws ProdutoInexistente, ProdutoVencido, DadosInvalidos, ProdutoNaoPerecivel, ProdutoJaCadastrado {
        Fornecedor f1 = new Fornecedor(1, "Forn1");
        Produto p2 = new ProdutoPerecivel(2, "Arroz Maria", 10, 0.2, f1);
        ...
        try {
            val = est.vender(2, 20);
            fail("Não deveria mais vender");
        } catch (ProdutoInexistente ignored) {
        }
        maisUm = est.pesquisar(2);
        assertEquals(5, maisUm.getQuantidade());
    ...
    @Test
    public void testarVendaProdutosPereciveisVencidos()
            throws ProdutoJaCadastrado, DadosInvalidos, ProdutoInexistente, ProdutoNaoPerecivel, ProdutoVencido {
        Fornecedor f1 = new Fornecedor(1, "Forn1");
        Produto p2 = new ProdutoPerecivel(2, "Arroz Maria", 10, 0.2, f1);
        ...
        try {
            val = est.vender(2, 20);
            fail("Não deveria mais vender. Só vencidos.");
        } catch (ProdutoVencido ignored) {
        }
        assertEquals(40, maisUm.getQuantidade());
    ...
    @Test
    public void testarVendaProdutosPereciveisInvalidos()
            throws ProdutoJaCadastrado, ProdutoVencido, ProdutoInexistente, DadosInvalidos, ProdutoNaoPerecivel {
        Fornecedor f1 = new Fornecedor(1, "Forn1");
        Produto p2 = new ProdutoPerecivel(2, "Arroz Maria", 10, 0.2, f1);
        Produto p1 = new Produto(1, "coca-cola", 5, 0.5, f1);
