...
public class ProdutoPerecivel extends Produto{
    ...
    public ProdutoPerecivel(long codigo, String descricao, int estoque_minimo, double lucro, Fornecedor fornecedor) {
    ...
    public double venda_perecivel(long cod, int quant){
        Date hoje = new Date();
        int inicial = quant;
